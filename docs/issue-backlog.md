...
Use these local issue numbers when asking an agent to work autonomously.
...
- `#1` Build phone hands-off practice session player - [docs/issues/001-phone-hands-off-practice.md](issues/001-phone-hands-off-practice.md)
- `#2` Add auto import for Preply lesson PDFs - [docs/issues/002-preply-auto-import.md](issues/002-preply-auto-import.md)
